...
import cenclave_lib_sgx.http_server
from cenclave_lib_sgx.certificate import Certificate
import cenclave_lib_sgx.globs as globs
import pytest
...
def set_env(tmp_path_factory) -> None:
    ...
    module_dir_path = tmp_path_factory.mktemp("app")
...
def conf_server(host, port, uuid, certificate):
    proc = multiprocessing.Process(
        target=cenclave_lib_sgx.http_server.serve,
